...
@pytest.mark.e2e_model("google/gemma-4-31B-it")
@pytest.mark.e2e_coverage(
    arch="dense",
    feature="",
    parallel="TP",
...
@patch.dict(os.environ, _GRAPH_ENV)
@wait_until_npu_memory_free()
def test_gemma4_31b_dense_full_decode_graph() -> None:
    """Verify Gemma4 dense startup, graph capture, and short generation."""
    _run_full_decode_graph_smoke("google/gemma-4-31B-it", enable_expert_parallel=False)
