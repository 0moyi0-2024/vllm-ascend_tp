...
ASCEND_RT_VISIBLE_DEVICES=2,3 HCCL_OP_EXPANSION_MODE=AIV HCCL_BUFFSIZE=256 \
vllm serve /home/xty/gemma4/31B \
  --served-model-name gemma-4-31B-it --tensor-parallel-size 2 --enable-expert-parallel \
