...
# COMMON_FLAGS: workarounds required for gemma4 on this build (see env/boot_findings.md)
#   --enforce-eager : FULL_DECODE_ONLY cudagraph capture fails (ACL 107033)
...
COMMON_FLAGS="--enforce-eager --max-model-len 8192 --block-size 128"
